...
export class State {
    ...
    */
    constructor(state) {
        const ret = wasm.state_new(addHeapObject(state));
    ...
    */
    get() {
        const ret = wasm.state_get(this.__wbg_ptr);
    ...
    */
    get_key(key) {
        ...
        const ret = wasm.state_get_key(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {any} state
    */
    set(state) {
        wasm.state_set(this.__wbg_ptr, addHeapObject(state));
    }
    /**
    * @param {string} key
    * @param {any} value
    */
    insert(key, value) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.state_insert(this.__wbg_ptr, ptr0, len0, addHeapObject(value));
    }
    /**
    * @param {string} key
    * @param {any} value
    */
    update(key, value) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.state_update(this.__wbg_ptr, ptr0, len0, addHeapObject(value));
    }
    /**
    * @param {string} key
    */
    remove(key) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.state_remove(this.__wbg_ptr, ptr0, len0);
    }
    /**
    */
    clear() {
        wasm.state_clear(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('react_state_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
